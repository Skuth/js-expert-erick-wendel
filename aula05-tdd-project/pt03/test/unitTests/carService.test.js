...
describe("CarService Suite Tests", () => {
  ...
  it("should retrieve a random position from an array", () => {
    ...
    expect(result).to.be.lte(data.length)
  })
  ...
  it("given a carCategory, customer and numberOfDays it should calculate final amoun in real", async () => {
